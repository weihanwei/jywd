 ...
 * @version 1.00
 */
public final class MD5More {
	private static MD5More instance = null;
	 ...
	 * @return
	 */
	private static synchronized MD5More getInstance() {
		if (instance == null)
		{
			synchronized ( MD5More.class )
			{
				if (instance == null)
					instance = new MD5More();
			}
		}
		return instance;
	}
