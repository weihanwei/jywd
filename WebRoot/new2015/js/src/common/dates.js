    ...
    (function ($) {
        ...
        $.fn.date = function (options, Ycallback, Ncallback) {
            ...
            $.fn.date.defaultOptions = {
                ...
                mode: null,                       //操作模式（滑动模式）
                event: hasStart,                    //打开日期插件默认方式为点击后后弹出日期
                show: true
            }
            //用户选项覆盖插件默认选项
            ...
            function bindButton() {
                resetIndex();
                $("#dateconfirm").unbind(hasStart).click(function () {
            ...
            function addTimeStyle() {
                $("#datePage").css("height", "340px");
                $("#datePage").css("margin-top", "-170px");
                $("#yearwrapper").css("position", "absolute");
                $("#yearwrapper").css("bottom", "180px");
                $("#monthwrapper").css("position", "absolute");
                $("#monthwrapper").css("bottom", "180px");
                $("#daywrapper").css("position", "absolute");
                $("#daywrapper").css("bottom", "180px");
            }
