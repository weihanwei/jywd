...
<div class="main">
    <div class="login-wrap toScaned">
        <div class="toScanedText">您已经成功扫描二维码，请输入欲办理业务的 手机号码和验证码即可继续操作。</div>
        <div class="h1em"></div>
        <div class="ads-row">
            <div class="ads-c-12"><input type="text" class="ltextput J_footHide" id="jyn" placeholder="请输入用户手机号码"></div>
        </div>
        <!---type msg-->
        <div class="showContent">
            <div class="ads-row">
                <div class="ads-c-8 pr-1em">
                    <input type="text" class="ltextput J_footHide" id="code" placeholder="短信验证码">
                </div>
        ...
        <div class="ads-row">
            <div class="ads-c-12"><a href="javascript:" onclick="handle();" class="aBtn aBtn-blue"><span class="fem-12">确认办理</span></a>
            </div>
        </div>
    </div>
</div>
...
<script type="text/javascript">
    seajs.use(['jquery', 'JSBridge', 'main','tfAlert'], function (a) {
        seajs.use("${pageContext.request.contextPath}/new2015/js/" + SCRIPT_PATH + "/model/person/toScaned");
    });
