...
<div class="main">
    <div class="tipPMian">
       ...
       <%
       String result=request.getAttribute("payresult");
       
    	   <img src="${pageContext.request.contextPath}/new2015/images/common/play_no.png" />

        </div>
        <div class="f-l">
            <h5 class="tipPTitle">您宽带账号：<%=request.getAttribute("account") %>,支付<%=request.getAttribute("kdcost") %><%=request.getAttribute("productname") %>失败</h5>
