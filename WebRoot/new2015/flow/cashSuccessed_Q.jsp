<%@ page language="java" contentType="text/html; charset=UTF-8"
    pageEncoding="UTF-8"%>
<!DOCTYPE>
<html manifest="${pageContext.request.contextPath}/new2015/manifest/flow/cashSuccessed_Q.appcache">
<head> 
...
<div class="main">
    <div class="buyed">
        ...
        <div class="pd1em">
            <p class="cashText" id="msgTXT"></p>
        </div>
        <div class="pd1em">
            <a href="javascript:" id="aonClick"  class="aBtn aBtn-blue"><span class="fem-12">查看领取详情</span></a>
            <div class="h1em"></div>
...
<script type="text/javascript">
	seajs.use(['jquery','JSBridge','main','tmpl'], function(a) {
	    seajs.use("${pageContext.request.contextPath}/new2015/js/"+SCRIPT_PATH+"/model/flow/cashSuccessed_Q");
	});
</script>
